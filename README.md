...
| **RISC-V APB** <br> 📅(25.08.26 ~ 25.08.29) | - 설계한 RISC-V RV32I CPU에 **APB**를 추가하여 다양한 주변 장치를 연결<br> - **SystemVerilog Verification Testbench 구조**를 통해 DUT에 대한 검증<br> - **C -> 어셈블리어 -> 머신코드**로 변환 후 머신코드를 ROM에 넣어 정상적으로 동작하는 것을 확인 | 대한상공회의소 | [RISC-V AMBA APB](https://github.com/EunSeongL/RISCV-AMBA-APB) |
