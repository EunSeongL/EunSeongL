...
| **탄환지옥-생존의무대** <br> 📅(25.04.25 ~ 25.05.02) | - **ARM Cortex-M3** 기반의 마이크로컨트롤러에서 게임 로직 구현 및 **레지스터 기반 하드웨어 제어**<br> - 타이머, GPIO, PWM, 인터럽트 등 **데이터시트를 참고하여 필요한 레지스터 비트를 직접 활성화**하고 활용<br> - **임베디드** 환경에서 **레지스터 제어와 인터럽트 기반** 프로그래밍 이해 | 대한상공회의소 | [Avoid Bullets](https://github.com/EunSeongL/Avoid-Bullets) |
