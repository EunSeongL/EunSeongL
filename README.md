...
| **샘플링 기법 기반 확장 칼만 필터(EKF)를 이용한 배터리 SOC 추정 알고리즘의 하드웨어 구현** <br> 📅(2024.02 ~ 2024.06) | 여섯 번째 프로젝트에 대한 간결한 설명입니다. | 상명대학교 | [Battery-SOC-EKF](https://github.com/EunSeongL/Battery-SOC-EKF) |
