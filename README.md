...
| **AXI4 Lite Protocol** <br> 📅(25.09.04 ~ 25.09.08) | - AXI4-Lite 프로토콜 기반 Master-Slave 하드웨어 구조 설계<br> - 독립된 채널(Read/Write Address, Data, Response)의 동작 구현 및 검증<br> - Memory-mapped I/O 방식으로 Peripheral 주소 매핑 및 read/write 동작 검증<br> - 핸드셰이크 신호(VALID/READY)를 이용한 데이터 전송 제어 로직 설계
<img width="468" height="73" alt="image" src="https://github.com/user-attachments/assets/b38177fb-95e3-46da-a702-adaf829f82b5" />
 | 대한상공회의소 | [AXI4 Lite Protocol](https://github.com/EunSeongL/AXI4_Lite_Protocol) |
